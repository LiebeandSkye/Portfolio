...
const BotButton = () => {
    ...
    return (
        <div className="items-center border border-(--border-light) dark:border-(--dark-border) rounded-md flex">
            ...
            <button 
                onClick={() => setIsChatOpen(!isChatOpen)}
                className="fixed bottom-8 right-4 md:w-24 md:h-24 w-18 h-18  text-white bg-transparent flex items-center justify-center hover:scale-105 transition-transform z-[60] cursor-pointer"
            >
