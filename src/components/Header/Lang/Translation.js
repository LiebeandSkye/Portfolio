    ...
    en: {
        ...
        sakupilot: {
            ...
            immersive: {
                ...
                description: "Ask about Kry's projects, get portfolio strategy, analyze attached files, or use SakuPilot like a focused general AI assistant.",
                starter1: 'Review this portfolio like a senior recruiter.',
                starter2: 'Help me explain AI MemoryPorter in a premium way.',
    ...
    jp: {
        ...
        sakupilot: {
            ...
            immersive: {
                ...
                recent: '最近のチャット',
                noSavedChats: '保存された会話はまだありません。',
                rename: '名前を変更',
                delete: '削除',
                noMatch: '検索条件に一致するチャットはありません。',
                whereToBegin: '何から始めましょうか？',
                description: 'Kryのプロジェクトについて尋ねたり、ポートフォリオ戦略について相談したり、添付ファイルを分析したり、SakuPilotを多機能なAIアシスタントとしてお使いください。',
                starter1: 'シニアリクルーターのようにこのポートフォリオをレビューしてください。',
                starter2: 'AI MemoryPorterの魅力的な説明を考えてください。',
                starter3: 'プロジェクトを比較し、次に何を改善すべきか提案してください。',
        ...
        projects: {
            ...
            sakikaraoke: {
                ...
                Information: {
                    ...
                    description: 'SakiKaraokeは、リアルタイムで共同利用できるカラオケWebアプリケーションです。ユーザーは6文字のコードでバーチャルルームを作成し、友達と共有して一緒に歌うことができます。独自の同期アーキテクチャにより全員の再生状態が同期され、タイムスタンプ付きのLRC歌詞がリアルタイムでスクロールします。',
                    coreFeatures: {
                        title: 'コア機能',
                    ...
                    howItWorks: {
                        ...
                        description: 'SakiKaraokeは、共同機能とサブ秒単位 of 同期を組み合わせて、プレミアムなカラオケ体験を提供します。',
                    },
                    howIBuiltIt: {
                        title: 'このプロジェクトの構築方法',
                        frameworks: {
