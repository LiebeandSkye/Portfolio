...
const NavButton = memo(function NavButton({ path, label, onClick }) {
    return (
        <button
        ...
        >
            <span className="w-5 h-5 rounded-md border border-(--border-light) flex items-center justify-center flex-shrink-0">
